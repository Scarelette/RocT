...
import com.happy.TCPconnection.TcpConnection;
import com.happy.gui.ClientButtonListener;
import com.happy.gui.ClientProxyListener;
import com.happy.gui.ClientRun;
import com.happy.replyon.RocTMessage;
import com.happy.replyon.RocTMessageType;
...
public class RocTClientHandler extends CommonHandler{
    ...
    public ClientProxyListener clientProxyListener = new ClientProxyListener();
    private ClientRun clientRun;

    public RocTClientHandler(String password, LinkedList<String> resultsDemo, ClientButtonListener clientButtonListener, ClientProxyListener clientProxyListener,ConcurrentHashMap<Integer,String> remoteToProxy) {
    	results = resultsDemo;
    ...
    public void processRegisterResult(RocTMessage msg) throws Exception {
    	if(!registered) {
    		if(msg.getResult().equals("false")) {
                ...
                clientRun = new ClientRun(results, this);
                clientRun.showUI();
    ...
    private void processConnected(RocTMessage msg) throws Exception {
        ...
        try {
            ...
            RocTClientHandler thisHandler = this;
