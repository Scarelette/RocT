...
import com.happy.TcpServer.httpsProxyServer;
...
public class RocTServerHandler extends CommonHandler {
	
	static LinkedList<RocTServerHandler> HandlerList;
    ...
    public RocTServerHandler(String password, LinkedList<String> resultsDemo,int num,LinkedList<RocTServerHandler> HandlerListDemo) {
    ...
    private void processBind(RocTMessage roctMessage) {
        ...
        try {
            ...
            RocTServerHandler thisHandler = this;
            
            remoteServer.bind(port, new ChannelInitializer<SocketChannel>() {
                @Override
                public void initChannel(SocketChannel ch) throws Exception {
                	ServerProxyHandler proxyServerHandler = new ServerProxyHandler(thisHandler,port);
